...
import Functions.MyTree;
import Functions.RandomFunctions;
...
public class MyTreeTests {
	...
	public void testLeaves2() {
		...
		assertTrue(RandomFunctions.contains(leaves, 2));
		assertTrue(RandomFunctions.contains(leaves, 3));
		assertTrue(RandomFunctions.contains(leaves, 4));
	}
